# (Unofficial) eBay API client (PHP) - Buy / Feed
...
Please refer to [eBay's documentation](https://developer.ebay.com/api-docs/buy/marketing/overview.html) for detailed API behaviour explanation.
...
Starting from version v1_beta.29.0, this project will match according eBay API's versioning. Should you found a matching 
...
Client::configure(
    new \GuzzleHttp\Client([
        'base_uri' => 'https://api.ebay.com/buy/feed/v1_beta/',
        'headers'=>[
